...
const LandingIntro = () => {
    return (
        <Card className="shadow-lg rounded-2xl p-3 sm:p-6  w-full max-w-2xl mx-auto mb-10">
            <CardHeader className="p-2 sm:px-6">
                <CardTitle>
                    <h1 className="text-2xl sm:text-4xl font-extrabold tracking-tight text-pretty">
                        <span className="block">Hello,</span>{' '}
                        <span className="block ">Králik Norbert vagyok,</span>
                    </h1>
                </CardTitle>
                <CardDescription >
            ...
            <CardContent className="text-pretty p-2 sm:px-6">
                <p className="mb-4 text-foreground/80 dark:text-muted-foreground text-[15px] sm:text-base leading-relaxed">
                ...
                <p className="mb-2 text-foreground/80 dark:text-muted-foreground text-[15px] sm:text-base leading-relaxed">
